...
<path style="opacity:0.1;enable-background:new    ;" d="M110.74,411.879L110.74,411.879c0-11.449,9.281-20.73,20.73-20.73H70.521
	c-11.449,0-20.73,9.281-20.73,20.73l0,0c0,11.449,9.281,20.73,20.73,20.73h60.949C120.021,432.609,110.74,423.328,110.74,411.879z"></path><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g>
					...
					<?php $__currentLoopData = $forms->usersGroupe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userGroupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php if($userGroupe->id == $owner): ?>

						<?php else: ?>
						<img src="<?php echo e($userGroupe->profile_photo_path); ?>" alt="participant" id="participant">
						<?php endif; ?>
						<?php $compteurMembre++ ?>
					...
					<?php if($compteurMembre<6): ?>
						<?php if(Gate::allows('form-access', $forms)): ?>
							<a href="<?php echo e(route('groupes.create', $forms->id)); ?>" class="add-participant" style="color: <?php echo e($forms->color); ?>;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haya0002/public_html/V9Form/resources/views/forms/list.blade.php ENDPATH**/ ?>