    ...
    <div class="flex-grow flex overflow-x-hidden">
      <div class="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full overflow-y-auto lg:block hidden groupe-left">
        ...
        <div class="space-y-4 mt-3">
          ...
          <form action="<?php echo e(route('groupes.show', $forms->id)); ?>">
          <?php echo csrf_field(); ?>
          <button type="submit" class="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
            <div class="flex xl:flex-row flex-col items-center font-medium text-gray-900 dark:text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 dark:border-gray-700 w-full">
              <img src=" <?php echo e($forms->logo); ?> " class="w-7 h-7 mr-2 rounded-full" alt="profile">
...
<?php $__currentLoopData = $forms->usersGroupe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userGroupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php if($loop->first): ?>
    <b>membre(s) : </b>
  <?php endif; ?>
<?php $compteurMembre++ ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php echo e($compteurMembre); ?>


               </div> <!-- count nbr membre -->
              <div class="ml-auto text-xs text-gray-500"> <?php echo e(strftime('%d/%m/%Y', strtotime($forms->date))); ?> </div>
            </div>
          </a>
          </button>
          </form>
      ...
      <div class="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">
        ...
        <div class="sm:p-7 p-4">
          ...
          <?php if (! empty(trim($__env->yieldContent('GroupeInfo')))): ?>
            <?php echo $__env->yieldContent('GroupeInfo'); ?>
          <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.forms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haya0002/public_html/V9Form/resources/views/groupes/list.blade.php ENDPATH**/ ?>