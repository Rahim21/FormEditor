...
<head>
    ...
    <!-- Styles -->
    <?php echo $__env->yieldContent('groupeCSS'); ?>
    <link href="<?php echo e(asset('dist/dragula.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/style.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/app.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/builder.css')); ?>" rel="stylesheet">

    <!-- CSS only -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href=" <?php echo e(asset('img/FormEditor.png')); ?> "/>
    ...
    <?php echo $__env->yieldContent('ShowMessage'); ?>
...
<div class="app-container">
      ...
      <div class="app-header-right">
        <?php if(auth()->guard()->check()): ?>
          <?php if(Auth::user()->role_id ==1 || Auth::user()->role_id ==2): ?>
              <a href="<?php echo e(url('admin')); ?>" id="admin"><?php echo e(Auth::user()->role->role_nom); ?></a>
          <?php endif; ?>
        <?php endif; ?>
        ...
        <button class="profile-btn">
          ...
          <img src="<?php echo e(asset(array_rand(['img/defaut1.png'=>0, 'img/defaut2.png'=>1], 1))); ?>" />
          <?php else: ?>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                  ...
                                  <a class="dropdown-item" style="background-color: <?php echo e(Auth::user()->role->role_couleur.'8a'); ?>">
                                  <i class="bi bi-patch-check"></i>
                                  <?php echo e(Auth::user()->role->role_nom); ?>
    ...
    <div class="app-content">
      <div class="app-sidebar">
        <a href=" <?php echo e(url('forms')); ?> " class="app-sidebar-link mon-shadow ">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
            <polyline points="9 22 9 12 15 12 15 22"></polyline>
          </svg>
        </a>
        <a href=" <?php echo e(url('groupes')); ?> " class="app-sidebar-link mon-shadow <?php echo e(str_contains(request()->url(), 'groupes') ? 'active' : ''); ?>">
...
326 318 342 327 49 26 143 17 190 -18z"/>
    ...
    <main class="<?php echo $__env->yieldContent('main'); ?>">
...
<script src="<?php echo e(asset('dist/dragula.min.js')); ?>"></script>
<script src="<?php echo e(asset('dist/jspdf.umd.min.js')); ?>"></script>
<script src="<?php echo e(asset('html2canvas.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/builder.js')); ?>"></script>
</body>
</html><?php /**PATH /home/haya0002/public_html/V9Form/resources/views/layouts/forms.blade.php ENDPATH**/ ?>