...
<body>
    ...
    <div class="app-header">
      <div class="app-header-left">
        ...
        <p class="app-name"><a class="text-decoration-none text-reset" href="<?php echo e(url('/')); ?>"> <?php echo e(__('FormEditor')); ?> </a></p>
        <form action="<?php echo e(url('/')); ?>" method="POST" class="search-wrapper mon-shadow">
      ...
      <div class="messages-section mon-shadow">
        ...
        <div class="messages">
          ...
          <?php $__currentLoopData = $formsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($compteurGroupe<=10): ?>
            <div class="message-box">
              <img src="<?php echo e($forms->logo); ?>" alt="profile image">
              <div class="message-content">
                <div class="message-header">
                  <div class="name"><?php echo e($forms->title); ?></div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo e(route('recherche')); ?>",
   method:'GET',
   data:{query:query},
   dataType:'json',
...
<?php /**PATH /home/haya0002/public_html/V9Form/resources/views/layouts/app.blade.php ENDPATH**/ ?>