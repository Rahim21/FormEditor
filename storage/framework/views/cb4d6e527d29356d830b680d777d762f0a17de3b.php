                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nom')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Confirmer votre Mot de Passe')); ?></label>
                        ...
                        <div class="form-group row">
                            <label for="role_confirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Votre Statut')); ?></label>
                            <div class="col-md-6">
                                <select class="browser-default custom-select" name="role_confirm">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haya0002/public_html/FormEditorVTest/resources/views/auth/register.blade.php ENDPATH**/ ?>