	...
	<a href="<?php echo e(route('forms.create')); ?>" id="addform">
		<div class="project-box border-fade" style="background-color: #1f1c2e;">
			<div class="project-box-header">
				...
				<div class="badge" id="role" style="background-color: <?php $__currentLoopData = Auth::user()->role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($role->role_couleur); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;"> <?php $__currentLoopData = Auth::user()->role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($role->role_nom); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> </div>
				</span>
			</div>
...
<path style="opacity:0.1;enable-background:new    ;" d="M110.74,411.879L110.74,411.879c0-11.449,9.281-20.73,20.73-20.73H70.521
	c-11.449,0-20.73,9.281-20.73,20.73l0,0c0,11.449,9.281,20.73,20.73,20.73h60.949C120.021,432.609,110.74,423.328,110.74,411.879z"></path><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g>
					...
					<img src="<?php echo e(asset(array_rand(['logo/defaut1.png'=>0, 'logo/defaut2.png'=>1], 1))); ?>" alt="participant" id="participant">
					<?php else: ?>
	...
	<div class="project-box-wrapper curl-top-left">
		<div class="project-box" style="background-color: <?php echo e($forms->color); ?>8a;">
			<div class="project-box-header">
				...
				<div class="badge" id="role" style="background-color: <?php $__currentLoopData = $forms->user->role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($role->role_couleur); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;"> <?php $__currentLoopData = $forms->user->role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($role->role_nom); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> </div>
				</span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haya0002/public_html/FormEditorVTest/resources/views/forms/list.blade.php ENDPATH**/ ?>