<?php $__env->startSection('main'); ?> py-4 displayBuilder <?php $__env->stopSection(); ?>
...
unset($__errorArgs, $__bag); ?>" name="date" id="date" placeholder="Date" value="<?php echo e(old('date')); ?>"/>
        <input form="form-builder" type="hidden" id="logo" name="logo" value="<?php echo e(asset('img/groupe.png')); ?>">
    </div>
...
<?php echo $__env->make('layouts.forms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/haya0002/public_html/V9Form/resources/views/forms/create.blade.php ENDPATH**/ ?>