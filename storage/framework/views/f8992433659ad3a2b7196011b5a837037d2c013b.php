    ...
    <div class="app-content">
      ...
      <div class="projects-section shadow-lg">
        <div class="projects-section-header">
          ...
          <?php if(auth()->guard()->check()): ?><p class="time"> <?php echo e(Auth::user()->firstname); ?> </p><?php endif; ?>
        </div>
...
<?php /**PATH /home/haya0002/public_html/FormEditor/resources/views/layouts/app.blade.php ENDPATH**/ ?>